...
CREATE TABLE `branchtransfers` ( -- information for items that are in transit between branches
  ...
  `cancellation_reason` ENUM('Manual', 'StockrotationAdvance', 'StockrotationRepatriation', 'ReturnToHome', 'ReturnToHolding', 'RotatingCollection', 'Reserve', 'LostReserve', 'CancelReserve') default NULL, -- what triggered the transfer cancellation
