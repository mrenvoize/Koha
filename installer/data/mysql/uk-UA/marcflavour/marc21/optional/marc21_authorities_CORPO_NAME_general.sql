...
INSERT INTO auth_tag_structure  (authtypecode, tagfield, mandatory, repeatable, liblibrarian, libopac, authorised_value) VALUES
 ('CORPO_NAME', '000', 1, 0, 'Маркер', 'Маркер', NULL),
 ('CORPO_NAME', '001', 1, 0, 'Контрольний номер', 'Контрольний номер', NULL),
 ('CORPO_NAME', '003', 1, 0, 'Ідентифікатор контрольного номера', 'Ідентифікатор контрольного номера', NULL),
 ('CORPO_NAME', '005', 1, 0, 'Дата і час останньої транзакції', 'Дата і час останньої транзакції', NULL),
 ('CORPO_NAME', '008', 1, 0, 'Елементи даних фіксованої довжини', 'Елементи даних фіксованої довжини', NULL),
 ('CORPO_NAME', '010', 0, 0, 'Контрольний номер Бібліотеки Конгресу', 'Контрольний номер Бібліотеки Конгресу', NULL),
 ('CORPO_NAME', '014', 0, 1, 'Зв’язок з бібліографічним записом на серіальну чи багатотомну одиницю', 'Зв’язок з бібліографічним записом на серіальну чи багатотомну одиницю', NULL),
 ('CORPO_NAME', '016', 0, 1, 'Контрольний номер національної бібліографічної агенції', 'Контрольний номер національної бібліографічної агенції', NULL),
 ('CORPO_NAME', '020', 0, 1, 'Міжнародний стандартний книжковий номер ISBN', 'Міжнародний стандартний книжковий номер ISBN', NULL),
 ('CORPO_NAME', '022', 0, 1, 'Міжнародний стандартний номер серіального видання ISSN', 'Міжнародний стандартний номер серіального видання ISSN', NULL),
 ('CORPO_NAME', '024', 0, 1, 'Інший стандартний ідентифікатор', 'Інший стандартний ідентифікатор', NULL),
 ('CORPO_NAME', '031', 0, 1, 'MUSICAL INCIPITS INFORMATION', 'MUSICAL INCIPITS INFORMATION', NULL),
 ('CORPO_NAME', '035', 0, 1, 'Контрольний номер системи', 'Контрольний номер системи', NULL),
 ('CORPO_NAME', '040', 1, 0, 'Джерело каталогізації', 'Джерело каталогізації', NULL),
 ('CORPO_NAME', '042', 0, 0, 'Код справжності [автентичності]', 'Код справжності [автентичності]', NULL),
 ('CORPO_NAME', '043', 0, 0, 'Код географічного регіону', 'Код географічного регіону', NULL),
 ('CORPO_NAME', '045', 0, 0, 'Хронологічний період, що відноситься до заголовку', 'Хронологічний період, що відноситься до заголовку', NULL),
 ('CORPO_NAME', '050', 0, 1, 'Расстановочний шифр Бібліотеки Конгресу', 'Расстановочний шифр Бібліотеки Конгресу', NULL),
 ('CORPO_NAME', '052', 0, 1, 'Класифікаційний код географічного регіону', 'Класифікаційний код географічного регіону', NULL),
 ('CORPO_NAME', '053', 0, 1, 'Класифікаційний індекс БК', 'Класифікаційний індекс БК', NULL),
 ('CORPO_NAME', '055', 0, 1, 'NATIONAL LIBRARY AND ARCHIVE OF CANADA CALL NUMBER', 'NATIONAL LIBRARY AND ARCHIVE OF CANADA CALL NUMBER', NULL),
 ('CORPO_NAME', '060', 0, 1, 'Розстановочний шифр Національної медичної бібліотеки', 'Розстановочний шифр Національної медичної бібліотеки', NULL),
 ('CORPO_NAME', '065', 0, 1, 'OTHER Класифікаційний індекс', 'OTHER Класифікаційний індекс', NULL),
 ('CORPO_NAME', '066', 0, 0, 'Використовувані набори символів', 'Використовувані набори символів', NULL),
 ('CORPO_NAME', '070', 0, 1, 'Розстановочний шифр Національної сільськогосподарської бібліотеки', 'Розстановочний шифр Національної сільськогосподарської бібліотеки', NULL),
 ('CORPO_NAME', '072', 0, 1, 'Код тематичної категорії', 'Код тематичної категорії', NULL),
 ('CORPO_NAME', '073', 0, 0, 'Використання підзаголовку', 'Використання підзаголовку', NULL),
 ('CORPO_NAME', '082', 0, 1, 'Розстановочний шифр за Десятковою класифікацією Дьюї', 'Розстановочний шифр за Десятковою класифікацією Дьюї', NULL),
 ('CORPO_NAME', '083', 0, 1, 'Класифікаційний індекс Десяткової класифікації Дьюї', 'Класифікаційний індекс Десяткової класифікації Дьюї', NULL),
 ('CORPO_NAME', '086', 0, 1, 'GOVERNMENT DOCUMENT CALL NUMBER', 'GOVERNMENT DOCUMENT CALL NUMBER', NULL),
 ('CORPO_NAME', '087', 0, 1, 'GOVERNMENT DOCUMENT Класифікаційний індекс', 'GOVERNMENT DOCUMENT Класифікаційний індекс', NULL),
 ('CORPO_NAME', '091', 0, 0, 'LOCALLY ASSIGNED LC-TYPE Класифікаційний індекс (OCLC); LOCAL Класифікаційний індекс (RLIN)', 'LOCALLY ASSIGNED LC-TYPE Класифікаційний індекс (OCLC); LOCAL Класифікаційний індекс (RLIN)', NULL),
 ('CORPO_NAME', '092', 0, 1, 'LOCALLY ASSIGNED DEWEY CALL NUMBER (OCLC)', 'LOCALLY ASSIGNED DEWEY CALL NUMBER (OCLC)', NULL),
 ('CORPO_NAME', '093', 0, 1, 'LOCALLY ASSIGNED DEWEY Класифікаційний індекс (OCLC)', 'LOCALLY ASSIGNED DEWEY Класифікаційний індекс (OCLC)', NULL),
 ('CORPO_NAME', '096', 0, 1, 'LOCALLY ASSIGNED NLM-TYPE CALL NUMBER (OCLC)', 'LOCALLY ASSIGNED NLM-TYPE CALL NUMBER (OCLC)', NULL),
 ('CORPO_NAME', '097', 0, 1, 'LOCALLY ASSIGNED NLM-TYPE Класифікаційний індекс (OCLC)', 'LOCALLY ASSIGNED NLM-TYPE Класифікаційний індекс (OCLC)', NULL),
 ('CORPO_NAME', '098', 0, 1, 'OTHER CLASSIFICATION SCHEMES (OCLC)', 'OTHER CLASSIFICATION SCHEMES (OCLC)', NULL),
 ('CORPO_NAME', '110', 0, 0, 'Заголовок — найменування організації', 'Заголовок — найменування організації', NULL),
 ('CORPO_NAME', '260', 0, 1, 'Комплексне посилання „див.“ — предмет', 'Комплексне посилання „див.“ — предмет', NULL),
 ('CORPO_NAME', '360', 0, 1, 'Комплексне посилання „див. також“ — предмет', 'Комплексне посилання „див. також“ — предмет', NULL),
 ('CORPO_NAME', '400', 0, 1, 'Трасування посилання „див.“ — ім’я особи', 'Трасування посилання „див.“ — ім’я особи', NULL),
 ('CORPO_NAME', '410', 0, 1, 'Трасування посилання „див.“ — назва організації', 'Трасування посилання „див.“ — назва організації', NULL),
 ('CORPO_NAME', '411', 0, 1, 'Трасування посилання „див.“ — назва заходу', 'Трасування посилання „див.“ — назва заходу', NULL),
 ('CORPO_NAME', '430', 0, 1, 'Трасування посилання „див.“ — уніфікований заголовок', 'Трасування посилання „див.“ — уніфікований заголовок', NULL),
 ('CORPO_NAME', '448', 0, 1, 'SEE FROM TRACING--CHRONOLOGICAL TERM', 'SEE FROM TRACING--CHRONOLOGICAL TERM', NULL),
 ('CORPO_NAME', '450', 0, 1, 'Трасування посилання „див.“ — тематичний термін', 'Трасування посилання „див.“ — тематичний термін', NULL),
 ('CORPO_NAME', '451', 0, 1, 'Трасування посилання „див.“ — георафічна назва', 'Трасування посилання „див.“ — георафічна назва', NULL),
 ('CORPO_NAME', '455', 0, 1, 'SEE FROM TRACING--GENRE/FORM TERM', 'SEE FROM TRACING--GENRE/FORM TERM', NULL),
 ('CORPO_NAME', '480', 0, 1, 'SEE FROM TRACING--GENERAL SUBDIVISION', 'SEE FROM TRACING--GENERAL SUBDIVISION', NULL),
 ('CORPO_NAME', '481', 0, 1, 'SEE FROM TRACING--GEOGRAPHIC SUBDIVISION', 'SEE FROM TRACING--GEOGRAPHIC SUBDIVISION', NULL),
 ('CORPO_NAME', '482', 0, 1, 'SEE FROM TRACING--CHRONOLOGICAL SUBDIVISION', 'SEE FROM TRACING--CHRONOLOGICAL SUBDIVISION', NULL),
 ('CORPO_NAME', '485', 0, 1, 'SEE FROM TRACING--FORM SUBDIVISION', 'SEE FROM TRACING--FORM SUBDIVISION', NULL),
 ('CORPO_NAME', '500', 0, 1, 'Трасування посилання „див. також“ — ім’я особи', 'Трасування посилання „див. також“ — ім’я особи', NULL),
 ('CORPO_NAME', '510', 0, 1, 'Трасування посилання „див. також“ — найменування організації', 'Трасування посилання „див. також“ — найменування організації', NULL),
 ('CORPO_NAME', '511', 0, 1, 'Трасування посилання „див. також“ — найменування заходу', 'Трасування посилання „див. також“ — найменування заходу', NULL),
 ('CORPO_NAME', '530', 0, 1, 'Трасування посилання „див. також“ — Уніфікований заголовок', 'Трасування посилання „див. також“ — Уніфікований заголовок', NULL),
 ('CORPO_NAME', '548', 0, 1, 'SEE ALSO FROM TRACING--CHRONOLOGICAL TERM', 'SEE ALSO FROM TRACING--CHRONOLOGICAL TERM', NULL),
 ('CORPO_NAME', '550', 0, 1, 'Трасування посилання „див. також“ — тематичний термін', 'Трасування посилання „див. також“ — тематичний термін', NULL),
 ('CORPO_NAME', '551', 0, 1, 'Трасування посилання „див. також“ — географічна назва', 'Трасування посилання „див. також“ — географічна назва', NULL),
 ('CORPO_NAME', '555', 0, 1, 'SEE ALSO FROM TRACING--GENRE/FORM TERM', 'SEE ALSO FROM TRACING--GENRE/FORM TERM', NULL),
 ('CORPO_NAME', '580', 0, 1, 'SEE ALSO FROM TRACING--GENERAL SUBDIVISION', 'SEE ALSO FROM TRACING--GENERAL SUBDIVISION', NULL),
 ('CORPO_NAME', '581', 0, 1, 'SEE ALSO FROM TRACING--GEOGRAPHIC SUBDIVISION', 'SEE ALSO FROM TRACING--GEOGRAPHIC SUBDIVISION', NULL),
 ('CORPO_NAME', '582', 0, 1, 'SEE ALSO FROM TRACING--CHRONOLOGICAL SUBDIVISION', 'SEE ALSO FROM TRACING--CHRONOLOGICAL SUBDIVISION', NULL),
 ('CORPO_NAME', '585', 0, 1, 'SEE ALSO FROM TRACING--FORM SUBDIVISION', 'SEE ALSO FROM TRACING--FORM SUBDIVISION', NULL),
 ('CORPO_NAME', '663', 0, 0, 'Комплексна посилання „див. також“ — ім’я/найменування', 'Комплексна посилання „див. також“ — ім’я/найменування', NULL),
 ('CORPO_NAME', '664', 0, 0, 'Комплексне посилання „див.“ — ім’я/найменування', 'Комплексне посилання „див.“ — ім’я/найменування', NULL),
 ('CORPO_NAME', '665', 0, 0, 'Історична довідка', 'Історична довідка', NULL),
 ('CORPO_NAME', '666', 0, 0, 'Загальна пояснювальна довідка — ім’я/найменування', 'Загальна пояснювальна довідка — ім’я/найменування', NULL),
 ('CORPO_NAME', '667', 0, 1, 'Загальне зауваження, не призначене для користувача', 'Загальне зауваження, не призначене для користувача', NULL),
 ('CORPO_NAME', '670', 0, 1, 'Джерело, в якому знайдені дані', 'Джерело, в якому знайдені дані', NULL),
 ('CORPO_NAME', '675', 0, 0, 'Джерело, в якому дані не знайдені', 'Джерело, в якому дані не знайдені', NULL),
 ('CORPO_NAME', '678', 0, 1, 'BIOGRAPHICAL OR HISTORICAL DATA', 'BIOGRAPHICAL OR HISTORICAL DATA', NULL),
 ('CORPO_NAME', '680', 0, 1, 'Загальне зауваження, призначене для користувача', 'Загальне зауваження, призначене для користувача', NULL),
 ('CORPO_NAME', '681', 0, 1, 'Примітка до прикладу трасування предметного заголовку', 'Примітка до прикладу трасування предметного заголовку', NULL),
 ('CORPO_NAME', '682', 0, 0, 'Інформація про вилуений заголовок', 'Інформація про вилуений заголовок', NULL),
 ('CORPO_NAME', '683', 0, 1, 'Примітка до історії застосування', 'Примітка до історії застосування', NULL),
 ('CORPO_NAME', '688', 0, 1, 'Примітка до історії застосування', 'Примітка до історії застосування', NULL),
 ('CORPO_NAME', '700', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--Ім’я особи', 'ESTABLISHED HEADING LINKING ENTRY--Ім’я особи', NULL),
 ('CORPO_NAME', '710', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--CORPORATE NAME', 'ESTABLISHED HEADING LINKING ENTRY--CORPORATE NAME', NULL),
 ('CORPO_NAME', '711', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--MEETING NAME', 'ESTABLISHED HEADING LINKING ENTRY--MEETING NAME', NULL),
 ('CORPO_NAME', '730', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--Уніфікований заголовок', 'ESTABLISHED HEADING LINKING ENTRY--Уніфікований заголовок', NULL),
 ('CORPO_NAME', '748', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--CHRONOLOGICAL TERM', 'ESTABLISHED HEADING LINKING ENTRY--CHRONOLOGICAL TERM', NULL),
 ('CORPO_NAME', '750', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--TOPICAL TERM', 'ESTABLISHED HEADING LINKING ENTRY--TOPICAL TERM', NULL),
 ('CORPO_NAME', '751', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--Географічна назва', 'ESTABLISHED HEADING LINKING ENTRY--Географічна назва', NULL),
 ('CORPO_NAME', '755', 0, 1, 'ESTABLISHED HEADING LINKING ENTRY--GENRE/FORM TERM', 'ESTABLISHED HEADING LINKING ENTRY--GENRE/FORM TERM', NULL),
 ('CORPO_NAME', '780', 0, 1, 'SUBDIVISION LINKING ENTRY--GENERAL SUBDIVISION', 'SUBDIVISION LINKING ENTRY--GENERAL SUBDIVISION', NULL),
 ('CORPO_NAME', '781', 0, 1, 'SUBDIVISION LINKING ENTRY--GEOGRAPHIC SUBDIVISION', 'SUBDIVISION LINKING ENTRY--GEOGRAPHIC SUBDIVISION', NULL),
 ('CORPO_NAME', '782', 0, 1, 'SUBDIVISION LINKING ENTRY--CHRONOLOGICAL SUBDIVISION', 'SUBDIVISION LINKING ENTRY--CHRONOLOGICAL SUBDIVISION', NULL),
 ('CORPO_NAME', '785', 0, 1, 'SUBDIVISION LINKING ENTRY--FORM SUBDIVISION', 'SUBDIVISION LINKING ENTRY--FORM SUBDIVISION', NULL),
 ('CORPO_NAME', '788', 0, 0, 'COMPLEX LINKING ENTRY DATA', 'COMPLEX LINKING ENTRY DATA', NULL),
 ('CORPO_NAME', '856', 0, 1, 'Місцезнаходження електронного ресурсу і доступ до нього', 'Місцезнаходження електронного ресурсу і доступ до нього', NULL),
 ('CORPO_NAME', '880', 0, 1, 'Альтернативне [що перемикається] подання графічних символів', 'Альтернативне [що перемикається] подання графічних символів', NULL);
