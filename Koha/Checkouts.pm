...
# sub GetOverdues {
#     my ( $patron_categorycode, $item_homebranch, $item_issuebranch ) = @_;
...
#         push @borrower_parameters, $item_homebranch;
#     } elsif ($item_issuebranch) {
#         $borrower_sql .= ' AND issues.branchcode=? ';
#         push @borrower_parameters, $item_issuebranch;
#     }
#     if ($patron_categorycode) {
#         $borrower_sql .= ' AND borrowers.categorycode=? ';
#         push @borrower_parameters, $patron_categorycode;
#     }
